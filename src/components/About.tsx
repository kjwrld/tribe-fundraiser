...
import imgFrame61835 from "figma:asset/18b23d1bd2eb6ab63946947bb1e5dfac933a6692.png";
import { imgInterfaceLeaderboard, imgInterfaceBadge } from "../imports/svg-a32gx";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="font-['Nunito:Regular',_sans-serif] text-[16px] sm:text-[18px] leading-[27px] text-[#8c92ab] text-center max-w-md mb-6 tracking-[0.36px]">
              <span className="font-['Nunito:Bold',_sans-serif] font-bold">Making STEM culturally relevant,</span>
            ...
            <div className="w-full max-w-4xl">
              <div 
                ...
                style={{ backgroundImage: `url('${imgFrame61773}')`, backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}
              />
            </div>
          </div>
        </div>
              ...
              <div className="flex-1 space-y-6">
                <div className="space-y-4">
                  <div className="bg-[rgba(198,133,255,0.3)] inline-flex items-center justify-center px-3 py-1 rounded-[12px]">
                    <span className="font-['Nunito:Medium',_sans-serif] font-medium text-[16px] text-[#a047ff]">Our Story</span>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    <div className="flex items-center justify-center w-12 h-12 p-3">
                      <img src={imgInterfaceLeaderboard} alt="Leaderboard" className="w-8 h-8" />
                    </div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex items-center justify-center w-12 h-12 p-3">
                      <img src={imgInterfaceBadge} alt="Badge" className="w-8 h-8" />
                    </div>
                    <p className="font-['Nunito:Regular',_sans-serif] text-[14px] leading-[24px] text-[#737992] flex-1">
            ...
            <div className="p-8 lg:p-16">
              ...
              <div className="mb-8 lg:hidden">
                <div className="bg-[rgba(198,133,255,0.3)] inline-flex items-center justify-center px-3 py-1 rounded-[12px] mb-4">
                  <span className="font-['Nunito:Medium',_sans-serif] font-medium text-[16px] text-[#a047ff]">Our Mission & Vision</span>
                </div>
              ...
              <div className="lg:hidden mb-8">
                <div 
                  ...
                  style={{ backgroundImage: `url('${imgText}')`, backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}
                />
              </div>
              ...
              <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                ...
                <div className="hidden lg:block flex-1 max-w-md">
                  <div 
                    ...
                    style={{ backgroundImage: `url('${imgText}')`, backgroundSize: '97.3% 108.77%', backgroundRepeat: 'no-repeat', backgroundPosition: '50% 99.81%' }}
                  />
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 gap-8">
            {teamMembers.map((member, index) => (
              <div key={index} className="backdrop-blur-[3.45px] backdrop-filter bg-[rgba(255,255,255,0.5)] rounded-[24px] border-2 border-[#00f5da] overflow-hidden">
                  ...
                  <div className="relative z-10 w-[335px] h-[272px] rounded-lg overflow-hidden">
                    <div 
                      ...
                      style={{ 
                        ...
                        backgroundSize: index === 1 ? '115.25% 252.35%' : index === 2 ? '140.3% 259.29%' : index === 3 ? '91.54% 122.4%' : index === 4 ? '115.82% 147.52%' : index === 5 ? '85.37% 108.74%' : '100% 133.71%',
                        backgroundRepeat: 'no-repeat',
                        backgroundPosition: index === 1 ? '23.57% 21.96%' : index === 2 ? '57.41% 9.03%' : index === 3 ? '62.94% 41.79%' : index === 4 ? '21.93% 6.47%' : index === 5 ? '47.96% 28.96%' : '0% 75.09%'
                      }}
                    />
                  </div>
            ...
            <div className="flex flex-col lg:flex-row items-center p-8 lg:p-16 gap-8 lg:gap-12">
              ...
              <div className="flex-1 space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="font-['Nunito:Regular',_sans-serif] text-[18px] leading-[27px] text-[#737992] tracking-[0.36px]">
                    A diverse team combining strategy, design, and technology to create impactful, innovative solutions.
                  </p>
                </div>
                ...
                <button className="bg-[#782acb] hover:bg-[#6b25b5] transition-colors duration-300 rounded-[12px] shadow-[0px_46px_13px_0px_rgba(120,43,201,0),0px_30px_12px_0px_rgba(120,43,201,0.01),0px_17px_10px_0px_rgba(120,43,201,0.05),0px_7px_7px_0px_rgba(120,43,201,0.09),0px_2px_4px_0px_rgba(120,43,201,0.1)] px-6 py-4 flex items-center gap-3 group">
                  ...
                  <svg className="w-6 h-6 text-white transition-transform duration-300 group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
